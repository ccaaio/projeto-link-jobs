    ...
    public function buscarUsuario() {
        ...
        if(isset($_POST["query"]))
        {
            ...
            if(mysqli_num_rows($result) > 0)
            {
                ...
                {
                    $output .= '<li style="background-color: #bdb2b2;line-height: 1.9;"><a href="/perfil/amigo/'.$row["id"].'" data-id-search="'.$row["id"].'" style="text-decoration: none !important; color: #FFFFFF !important;">'.$row["titulo"].'</a></li>';
                }
            }
            else
            {
